...
class Employee extends AdminController
{
    ...
    public function getEmployeesList()
    {
        ...
        foreach ($employee_data as $val){
            array_push($employee_list,$val);
        }
        $this->response_array['code']=200;
        $this->response_array['message']='Employee Feteched Succesfully';
        $this->response_array['data']['employee_list']=$employee_list;
